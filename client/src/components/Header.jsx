   ...
   const {userData} = useContext(AppContext)
    return (
        <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
           ...
           className='w-36 h-36 riunded-full mb-6'/>
           ...
           <p className="mb-8 max-w-md">Let's start with a quick product tour and we will have you and we will have you up and running in no time!</p>
